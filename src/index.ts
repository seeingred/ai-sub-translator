...
import { simpleServerApiHandlers } from './simpleServerApi';
...
const setupJsonRpcServer = () => {
    const server = jayson.server(simpleServerApiHandlers);
    ...
    httpServer.listen(port, () => {
        ...
        console.log('  - file.load         Load video or subtitle file');
        console.log('  - file.info         Get current file info');
        console.log('  - subtitle.extract  Extract subtitle from video');
        console.log('  - translation.start Start translation');
        console.log('  - translation.status Check progress');
        console.log('  - translation.result Get translated text');
        console.log('  - translation.save  Save to file');
        console.log('  - clear             Clear current file/job');
